...
export default function Home() {
  ...
  return (
    <main className="">
      ...
      {/* Sobre */}
      <div id="sobre" data-section="sobre" className="container pt-[5rem] grid justify-center items-center bg-gradient-to-bl from-green-primary to-green-secundary md:min-w-[100vw] w-screen h-screen" >
